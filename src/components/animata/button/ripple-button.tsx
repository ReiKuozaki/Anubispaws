...
export default function RippleButton({ children, ...props }: RippleButtonProps) {
  ...
  return (
    <button
      ref={buttonRef}
      className="cursor-pointer font-jost duration-[600ms] relative flex items-center justify-center overflow-hidden rounded-full bg-[#fefefe] p-[1.3rem] text-[1.2rem] font-medium text-[#000000] transition hover:text-white"
